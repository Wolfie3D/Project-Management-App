...
export default function index({ auth, projects, queryParams = null, success }) {
  ...
  const deleteProject = (project) => {
    if (!window.confirm("Are you sure you wan to delete the project?")) {
      return;
    }
      ...
      header={
        <div className='flex justify-between items-center'>
          ...
          <Link
            ...
            className='bg-emerald-500 py-1 px-2 text-white rounded shadow transition-all hover:bg-emerald-600'
          >
            Create
          </Link>
        </div>
